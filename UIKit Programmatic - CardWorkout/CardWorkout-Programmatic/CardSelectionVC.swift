...
class CardSelectionVC: UIViewController {
    ...
    func configureResetButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            resetButton.topAnchor.constraint(equalTo: stopButton.bottomAnchor, constant: 15)
        ])
    }
    ...
    @objc func rulesButtonTapped() {
        present(RulesVC(), animated: true) // Slide down from bottom func, its like segue but not same.
    }
}
